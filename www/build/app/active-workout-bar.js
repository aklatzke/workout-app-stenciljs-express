            ...
            h("stencil-router", null,
                h("stencil-route-switch", { scrollTopOffset: 0 },
                    ...
                    this.hasActiveWorkout ?
                        h("stencil-route", { url: "/workout/active/add", component: 'add-exercise', exact: true, componentProps: { uid: this.activeUser._id, activeWorkout: this.activeWorkout._id, activeExercises: this.activeWorkout.exercises.map(i => i.exerciseId) } }) :
                        null))));
    }
    maybeRenderBack() {
        if (this.backUrl) {
